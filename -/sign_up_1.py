...
class Signup_page(QMainWindow):
   ...
   # # *---------- phone number realtime check ---------- #
    ...
    def check_button_style_change(self):
        ...
        if self.fullname == '': self.fullname_error_label.setText('')
        if self.phone_number == '': self.phone_number_error_label.setText('')
        if self.email == '': self.email_error_label.setText('')
        ...
        # if self.phone_number != '' and self.button_valid_fullname :
        ...
        # if self.email != '' and self.button_valid_phone_number and self.button_valid_fullname:
        if self.email != '':
            if not is_valid_email(self.email):
                self.button_valid = False
            elif self.existing_user:
