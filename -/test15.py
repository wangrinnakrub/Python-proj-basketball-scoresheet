...
class ScoreSheetApp(QMainWindow):
    ...
    def ui(self):
        ...
        self.about_us_details_layout = QVBoxLayout(self.about_us_details)  # ใช้ QVBoxLayout เป็นเลย์เอาต์หลัก
    ...
    def addWidgetsToLayout(self, ui):
        ...
        user_icon = QPixmap(r'C:\pic\Copy of score sheet basketball project2.png')
        self.user_image_label.setPixmap(user_icon)
        self.user_image_label.setScaledContents(True)
        self.user_image_label.setFixedSize(40, 40)
        ...
        self.sidebar_button.setIcon(QIcon(r'C:\pic\Copy of score sheet basketball project.png'))
        ...
        self.user_image_label_layout.addWidget(self.user_image_label)
        ...
        self.set_up_match_button = QPushButton('Set Up Match')
    ...
    def fetch_username(self, username):
        ...
        self.cursor.execute("SELECT * FROM user_account WHERE username = ?", (username,))
    ...
    def toggle_sidebar(self):
        ...
        user_icon_x = self.user_image_label.x()
        new_button_x = self.set_up_match_button.x() - 360 if not self.sidebar_visible else self.set_up_match_button.x() + 360
        ...
        if self.sidebar_visible:
            ...
            self.button_animation.setEndValue(QPoint(self.set_up_match_button.x() + 360, self.set_up_match_button.y()))
        else:
            self.sidebar.setGeometry(self.width(), 0, 360, self.height())
            ...
            self.button_animation.setStartValue(self.set_up_match_button.pos())
            self.button_animation.setEndValue(QPoint(max(new_button_x, user_icon_x), self.set_up_match_button.y()))
