...
class ScoreSheetApp(QMainWindow):
    def __init__(self):
        ...
        # Variables to store scores and times
        self.home_score = 0
        self.away_score = 0
        ...
        self.timer_display.setStyleSheet("font-size: 20px; font-weight: bold;")
        ...
        quarter_spacer = QSpacerItem(200, 10, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        timer_layout.addWidget(self.quarter_label)
        timer_layout.addWidget(self.current_quarter_display)
        timer_layout.addItem(quarter_spacer)
        timer_layout.addStretch(18)
        timer_layout.addWidget(QLabel("Time:"))
        timer_layout.addWidget(self.timer_display)
        timer_layout.addStretch(20)
        timer_layout.addWidget(self.start_timer_button)
        timer_layout.addWidget(self.stop_timer_button)
        timer_layout.addWidget(self.reset_timer_button)  # เพิ่มปุ่ม Reset
        ...
        home_player_layout.addStretch()
        home_player_layout.addWidget(QLabel("Home Team Players"))
        home_player_layout.addSpacing(20)
        ...
        away_player_layout.addStretch()
        away_player_layout.addWidget(QLabel("Away Team Players"))
        away_player_layout.addSpacing(20)
